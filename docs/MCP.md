...
- **What it does**: Scope
- **Run it locally**: Running the server
- **Connect from Cursor**: Adding to Cursor
- **Tool shapes**: Tool parameters

## Scope

- **Tools:** `runfabric_doctor`, `runfabric_plan`, `runfabric_build`, `runfabric_deploy`, `runfabric_remove`, `runfabric_invoke`, `runfabric_logs`, `runfabric_list`, `runfabric_inspect`, `runfabric_releases`, `runfabric_generate`, `runfabric_state`, `runfabric_workflow`
