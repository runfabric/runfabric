...
**Development:** For step-by-step addon development (contract, catalog, permissions, testing), see [EXTENSION_DEVELOPMENT_GUIDE.md](EXTENSION_DEVELOPMENT_GUIDE.md) (Part 1: Addon development).
...
- [PLUGINS.md](PLUGINS.md) (plugins vs hooks)
- [EXTENSION_DEVELOPMENT_GUIDE.md](EXTENSION_DEVELOPMENT_GUIDE.md) (addon development)
