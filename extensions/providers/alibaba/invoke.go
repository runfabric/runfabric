...
func (Invoker) Invoke(ctx context.Context, cfg sdkprovider.Config, stage, function string, payload []byte, receipt any) (*sdkprovider.InvokeResult, error) {
	...
	if resp.StatusCode >= 400 {
		return &sdkprovider.InvokeResult{Provider: "alibaba-fc", Function: function, Output: fmt.Sprintf("HTTP %d: %s", resp.StatusCode, out)}, nil
	}
	return &sdkprovider.InvokeResult{Provider: "alibaba-fc", Function: function, Output: out}, nil
}
