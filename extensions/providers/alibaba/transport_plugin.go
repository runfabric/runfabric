...
// TransportPlugin implements sdkprovider.Plugin for Alibaba FC.
...
func (tp *TransportPlugin) Doctor(ctx context.Context, req sdkprovider.DoctorRequest) (*sdkprovider.DoctorResult, error) {
	return &sdkprovider.DoctorResult{Provider: "alibaba-fc", Checks: []string{"alibaba plugin loaded"}}, nil
}

func (tp *TransportPlugin) Plan(ctx context.Context, req sdkprovider.PlanRequest) (*sdkprovider.PlanResult, error) {
	return &sdkprovider.PlanResult{Provider: "alibaba-fc", Plan: map[string]any{"provider": "alibaba-fc", "stage": req.Stage, "root": req.Root}}, nil
}
