...
// TransportPlugin implements sdkprovider.Plugin for Cloudflare Workers.
...
func (tp *TransportPlugin) Doctor(ctx context.Context, req sdkprovider.DoctorRequest) (*sdkprovider.DoctorResult, error) {
	return &sdkprovider.DoctorResult{Provider: "cloudflare-workers", Checks: []string{"cloudflare plugin loaded"}}, nil
}

func (tp *TransportPlugin) Plan(ctx context.Context, req sdkprovider.PlanRequest) (*sdkprovider.PlanResult, error) {
	return &sdkprovider.PlanResult{Provider: "cloudflare-workers", Plan: map[string]any{"provider": "cloudflare-workers", "stage": req.Stage, "root": req.Root}}, nil
}
