...
// TransportPlugin implements sdkprovider.Plugin for DigitalOcean Functions.
...
func (tp *TransportPlugin) Doctor(ctx context.Context, req sdkprovider.DoctorRequest) (*sdkprovider.DoctorResult, error) {
	return &sdkprovider.DoctorResult{Provider: "digitalocean-functions", Checks: []string{"digitalocean plugin loaded"}}, nil
}

func (tp *TransportPlugin) Plan(ctx context.Context, req sdkprovider.PlanRequest) (*sdkprovider.PlanResult, error) {
	return &sdkprovider.PlanResult{Provider: "digitalocean-functions", Plan: map[string]any{"provider": "digitalocean-functions", "stage": req.Stage, "root": req.Root}}, nil
}
