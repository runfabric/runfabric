...
// TransportPlugin implements sdkprovider.Plugin for IBM OpenWhisk.
...
func (tp *TransportPlugin) Doctor(ctx context.Context, req sdkprovider.DoctorRequest) (*sdkprovider.DoctorResult, error) {
	return &sdkprovider.DoctorResult{Provider: "ibm-openwhisk", Checks: []string{"ibm plugin loaded"}}, nil
}

func (tp *TransportPlugin) Plan(ctx context.Context, req sdkprovider.PlanRequest) (*sdkprovider.PlanResult, error) {
	return &sdkprovider.PlanResult{Provider: "ibm-openwhisk", Plan: map[string]any{"provider": "ibm-openwhisk", "stage": req.Stage, "root": req.Root}}, nil
}
