...
// TransportPlugin implements sdkprovider.Plugin for Kubernetes provider.
...
func (tp *TransportPlugin) Doctor(ctx context.Context, req sdkprovider.DoctorRequest) (*sdkprovider.DoctorResult, error) {
	return &sdkprovider.DoctorResult{Provider: "kubernetes", Checks: []string{"kubernetes plugin loaded"}}, nil
}

func (tp *TransportPlugin) Plan(ctx context.Context, req sdkprovider.PlanRequest) (*sdkprovider.PlanResult, error) {
	return &sdkprovider.PlanResult{Provider: "kubernetes", Plan: map[string]any{"provider": "kubernetes", "stage": req.Stage, "root": req.Root}}, nil
}
