...
// TransportPlugin implements sdkprovider.Plugin for Netlify Functions.
...
func (tp *TransportPlugin) Doctor(ctx context.Context, req sdkprovider.DoctorRequest) (*sdkprovider.DoctorResult, error) {
	return &sdkprovider.DoctorResult{Provider: "netlify", Checks: []string{"netlify plugin loaded"}}, nil
}

func (tp *TransportPlugin) Plan(ctx context.Context, req sdkprovider.PlanRequest) (*sdkprovider.PlanResult, error) {
	return &sdkprovider.PlanResult{Provider: "netlify", Plan: map[string]any{"provider": "netlify", "stage": req.Stage, "root": req.Root}}, nil
}
