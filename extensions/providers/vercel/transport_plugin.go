...
// TransportPlugin implements sdkprovider.Plugin for Vercel.
...
func (tp *TransportPlugin) Doctor(ctx context.Context, req sdkprovider.DoctorRequest) (*sdkprovider.DoctorResult, error) {
	return &sdkprovider.DoctorResult{Provider: "vercel", Checks: []string{"vercel plugin loaded"}}, nil
}

func (tp *TransportPlugin) Plan(ctx context.Context, req sdkprovider.PlanRequest) (*sdkprovider.PlanResult, error) {
	return &sdkprovider.PlanResult{Provider: "vercel", Plan: map[string]any{"provider": "vercel", "stage": req.Stage, "root": req.Root}}, nil
}
