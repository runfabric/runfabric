...
func (r nodeRuntime) Build(_ context.Context, req BuildRequest) (*sdkprovider.Artifact, error) {
...
func (r pythonRuntime) Build(_ context.Context, req BuildRequest) (*sdkprovider.Artifact, error) {
...
func packageNodeFunction(root, functionName string, fn FunctionSpec, configSignature string) (*sdkprovider.Artifact, error) {
...
func packagePythonFunction(root, functionName string, fn FunctionSpec, configSignature string) (*sdkprovider.Artifact, error) {
