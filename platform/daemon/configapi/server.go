...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("POST /fabric/health", s.handleFabricHealth)
	mux.HandleFunc("POST /fabric/targets", s.handleFabricTargets)
	...
	mux.HandleFunc("POST /traces", s.handleTraces)
