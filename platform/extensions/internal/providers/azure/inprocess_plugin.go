...
func APIHooks() inprocess.APIDispatchHooks {
	return inprocess.APIDispatchHooks{
		...
		FetchMetrics:          FetchMetricsPolicy,
		FetchTraces:           FetchTracesPolicy,
		Recover:               RecoverPolicy,
		SyncOrchestrations:    SyncOrchestrationsPolicy,
		RemoveOrchestrations:  RemoveOrchestrationsPolicy,
		InvokeOrchestration:   InvokeOrchestrationPolicy,
		InspectOrchestrations: InspectOrchestrationsPolicy,
	}
}
